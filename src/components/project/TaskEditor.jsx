export default function TaskEditor({ project, task, onUpdateTask, onDeleteTask }) {
  ...
  return (
    <div className="task-editor">
      ...
      <label>상태<select value={task.status} onChange={(event) => onUpdateTask({ status: event.target.value })}><option value="todo">TODO</option><option value="doing">DOING</option><option value="done">DONE</option></select></label>
